...
%Example hierarchies: 
%Data hierarchy 1: Responsive neurons to stimulus. 
% Comparison: a. Baseline vs b. Response. Within neuron. 
%response
%1. Trials (divided into trial categories)
%2. Times (Window).

%Data hierarchy 2:
%1. Animals.
%2. Neurons. 
%3. Trials (divided into trial categories) --> . 
%2. Times (Window).
