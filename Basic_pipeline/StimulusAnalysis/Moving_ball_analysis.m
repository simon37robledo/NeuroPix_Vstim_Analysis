...
%
        ...
        ZscoreRaster = abs(ZscoreRaster); %%Use only absolute values of z-score. 
...
%
        ...
        if takeMedian
            ...
            save('MedianSem_values_Tuning','sem_values_Tuning')
        else
            save('MeanTuningValZS','tuningValZS')
            save('MeanSem_values_Tuning','sem_values_Tuning')
        end
