...
% Basic Variables:
% - base_dir : example path is: "\\132.66.45.127\data\Simon\Anesthesia_exp\Experiment_29_09_22";  
% 
% - run_dir : "\\132.66.45.127\data\Simon\SpikeGLX\"; %Folder that has catgt and tprime subfolders
% 
% - insertion : string of Id of insertion. If there is only one insertion and the data
% is directly under the "Experiment..." folder then insertion = "-1"
% 
% - fileName : Name that is shared across all files, normally it is
% "experiment".
% 
