function rez = remove_spikes(rez,remove_idx,label,varargin)
    ...
    if ~isfield(rez,'removed')
        [rez.removed.cProj,rez.removed.cProjPC,rez.removed.st0,rez.removed.st3] = deal([]);
        rez.removed.label={};
    end
    ...
    %rez.removed.st0 = cat(1,rez.removed.st0,rez.st0(remove_idx,:));
